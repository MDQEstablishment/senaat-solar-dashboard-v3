  ...
  React.useEffect(() => {
    ...
    const resolveSession = async (session) => {
      ...
      bootFromSupabase().then(() => {
        // R30.7 — Install realtime subscriptions for tasks / escalations / delivery_notes
        // AFTER boot completes so we don't race with the initial bulk load.
        try {
          if (typeof window !== 'undefined' && window.installRealtime) {
